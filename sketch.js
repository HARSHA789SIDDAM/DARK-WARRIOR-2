...
var entry,entryimg;
var entryimg2,entry2,entryimg1;
var db,dbimg;
var logo, logoimg;
...
function preload(){
	...
	entryimg1 = loadAnimation("entry/0.png","entry/1.png","entry/2.png","entry/3.png","entry/4.png","entry/5.png","entry/6.png","entry/7.png","entry/8.png","entry/9.png");
	entryimg = loadAnimation("he10/0.png","he10/1.png","he10/2.png","he10/3.png","he10/4.png","he10/5.png","he10/6.png","he10/7.png","he10/8.png");
	entryimg2 = loadImage("he10/6.png");
...
function setup(){
	...
	entry = createSprite(500, 280);
	entry.addAnimation("abs",entryimg1);
	entry.scale = 0.5;
	entry.velocityY = 1.2;

	db = createSprite(570, 110);
	db.addImage("hfg", dbimg);
	db.scale = 0.3;

	logo = createSprite(150, 150);
	logo.addImage("jjj", logoimg);
	logo.scale = 0.8;

	entry2 = createSprite(470, 350);
	entry2.addAnimation("sss", entryimg);
	entry2.scale = 1.4;
...
function draw(){
	...
	text("WITH YOUR OPPONENT", 480, 125);
